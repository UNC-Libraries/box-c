...
//    }
    ...
    public static Element makeXMLDatastreamElement(String id, String label, String versionId, Element xmlData, boolean versioned) {
	Element dcDS = new Element("datastream", JDOMNamespaceUtil.FOXML_NS);
	dcDS.setAttribute("ID", id);
     ...
     */
    public static void setDatastreamXmlContent(Document foxml, String datastreamId, String label, Element newContent, boolean versioned) {
	try {
