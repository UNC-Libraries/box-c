...
public class JDOMNamespaceUtil {
     ...
     */
    //public static final Namespace CDR_BASEMODEL_NS = Namespace.getNamespace(CDR_BASEMODEL_PREFIX, CDR_BASEMODEL_URI);

    /**
     * CDR namespace with "cdr" prefix
     */
    public static final Namespace CDR_NS = Namespace.getNamespace(CDR_PREFIX, CDR_URI);

    /**
     * CDR Messages namespace with "cdrmsg" prefix
     */
    public static final Namespace CDR_MESSAGE_NS = Namespace.getNamespace(CDR_MESSAGE_PREFIX, CDR_MESSAGE_URI);

    /**
     * DCMI namespace with standard prefix.
     */
    public static final Namespace DC_NS = Namespace.getNamespace(DC_PREFIX, DC_URI);

    /**
     * DCMI Metadata Terms namespace with standard prefix.
     */
    public static final Namespace DCTERMS_NS = Namespace.getNamespace(DCTERMS_PREFIX, DCTERMS_URI);
     ...
     */
    public static final Namespace LOCAL_RELS_NS = Namespace.getNamespace(LOCAL_RELS_PREFIX, LOCAL_RELS_URI);

    /**
     * METS v3 namespace (no prefix).
     */
    public static final Namespace METS_NS = Namespace.getNamespace(METS_PREFIX, METS_URI);

    /**
     * MODS V3 namespace with standard prefix.
     */
    public static final Namespace MODS_V3_NS = Namespace.getNamespace(MODS_V3_PREFIX, MODS_V3_URI);

    /**
     * MULGARA TQL response namespace (no prefix).
     */
    public static final Namespace MULGARA_TQL_NS = Namespace.getNamespace(MULGARA_TQL_URI);

    /**
     * OAI Dublin Core namespace with standard prefix.
     */
    public static final Namespace OAI_DC_NS = Namespace.getNamespace(OAI_DC_PREFIX, OAI_DC_URI);
     ...
     */
    public static final Namespace RDF_NS = Namespace.getNamespace(RDF_PREFIX, RDF_URI);

    /**
     * Fedora RELS-EXT namespace with standard prefix.
     */
    public static final Namespace RELSEXT_NS = Namespace.getNamespace(RELSEXT_PREFIX, RELSEXT_URI);

    // public static final Namespace SCHEMATRON_NS =
    // Namespace.getNamespace(SCHEMATRON_ISO_PREFIX, SCHEMATRON_ISO_URI);

    public static final Namespace SCHEMATRON_VALIDATION_REPORT_NS = Namespace.getNamespace(
		    SCHEMATRON_VALIDATION_REPORT_PREFIX, SCHEMATRON_VALIDATION_REPORT_URI);

    /**
     * XLink namespace with standard prefix.
     */
    public static final Namespace XLINK_NS = Namespace.getNamespace(XLINK_PREFIX, XLINK_URI);

    /**
     * Atom namespace with standard prefix.
     */
    public static final Namespace ATOM_NS = Namespace.getNamespace(ATOM_PREFIX, ATOM_URI);

    /**
     * FITS output namespace with standard prefix.
     */
    public static final Namespace FITS_NS = Namespace.getNamespace(FITS_PREFIX, FITS_URI);
