...
public interface VocabularyHelper {
	...
	/**
	 * Returns the authoritative version of the term provided. May return multiple matching forms, and each may contain
	 * multiple parts
	 *
	 * @param term
	 * @return
	...
	/**
	 * Returns a list of authoritative versions of all selected terms from the give document
	 *
	 * @param docElement
	 * @return
