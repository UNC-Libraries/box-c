     ...
     public Element call() throws EnhancementException {
          ...
          try {
               ...
               for (String srcURI : srcDSURIs) {
                    ...
                    dsLocation = newestSourceDS.getChild("contentLocation",
                            JDOMNamespaceUtil.FOXML_NS).getAttributeValue("REF");
                    ...
                    if (dsLocation != null) {
                         ...
                         if (exists) {
                              ...
                              client.modifyDatastreamByReference(pid,
                                        ...
                                        new ArrayList<String>(), "Derived JP2000 image", "image/jp2",
                                            null, null, convertResultURI);
                         } else {
                              ...
                              client.addManagedDatastream(pid,
                                        Datastream.IMAGE_JP2000.getName(), false, message,
                                            new ArrayList<String>(), "Derived JP2000 image",
                                                false, "image/jp2", convertResultURI);
                         }

                         // Add DATA_JP2, cdr-base:derivedJP2 relation triple
                         LOG.debug("Adding JP2 relationship");
                         PID newDSPID = new PID(
                                 pid.getPid() + "/" + ContentModelHelper.Datastream.IMAGE_JP2000.getName());
