...
public class ApplyEnhancementServicesJob implements Runnable {
    ...
    public ApplyEnhancementServicesJob(String messagePid, String messageNamespace, String messageAction,
            String messageServiceName, List<String> filteredServices) {
    ...
    public void run() {
        for (ObjectEnhancementService service : services) {
            ...
            try {
                ...
                LOG.error("Error determining applicability for service " + service.getClass().getName()
                        + " and object " + message.getTargetID(), e);
            }
            ...
            try {
                ...
                LOG.error("Error applying service " + service.getClass().getName() +
                        " to object " + message.getTargetID(), e);
