...
public enum SearchFieldKey {
    ...
    COLLECTION_SORT("collectionSort", "collectionSort", "Collection Sort"),
    COLLECTION_WORKS_ONLY("collectionWorksOnly", "collectionWorksOnly", "Collection Works Only"),
    COLLECTION_VIEW_TYPE("collectionViewType", "collectionViewType", "Collection View Type"),
