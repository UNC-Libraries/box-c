...
<div id="search_menu">
	...
	<div class="filter_menu">
		<div>
			<h3>Structure</h3>
			<c:set var="structureDataUrl">structure/<c:if test="${not empty resultResponse.selectedContainer}">${resultResponse.selectedContainer.id}/</c:if>collection<c:if test="${not empty searchStateUrl}">?${searchStateUrl}</c:if></c:set>
