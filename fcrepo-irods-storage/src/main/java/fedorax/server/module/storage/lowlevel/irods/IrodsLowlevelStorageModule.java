 ...
 *
 * To install this module, fedora.fcfg must reference this implementation and
 * the IrodsIFileSystem class.
 *
 * Additional required fedora.fcfg module parameters are: irods_host,
 * irods_port, irods_username, irods_password, irods_homeDirectory, irods_zone,
 * irods_defaultStorageResource.
 *
 */
public class IrodsLowlevelStorageModule extends Module implements ILowlevelStorage, IListable {
	...
	OBJECT_REGISTRY_TABLE("objectPaths"),
	...
	BACKSLASH_IS_ESCAPE("backslash_is_escape"),
	...
	IRODS_HOME_DIRECTORY("irods_homeDirectory"),
	IRODS_ZONE("irods_zone"),
	IRODS_DEFAULT_RESOURCE("irods_defaultStorageResource"),
	IRODS_READ_BUFFER_SIZE("irods_readBufferSize");
	...
	try {
	    ...
	    throw new ModuleInitializationException("Could not create IRODSFileSystem: "+e.getLocalizedMessage(), getRole());
	}
