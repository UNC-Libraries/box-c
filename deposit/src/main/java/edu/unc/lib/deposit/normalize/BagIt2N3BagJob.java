...
public class BagIt2N3BagJob extends AbstractFileServerToBagJob {
    ...
    private static final Timer timer = TimerFactory.createTimerForClass(BagIt2N3BagJob.class, "job-duration");
    ...
    public void runJob() {
        try (Timer.Context context = timer.time()) {
            ...
            if (!bag.verifyComplete().isSuccess()) {
                ...
                failJob("Unable to normalize bag " + sourcePath
                        + ", it was not complete according to bagit specifications", msg.toString());
            }
