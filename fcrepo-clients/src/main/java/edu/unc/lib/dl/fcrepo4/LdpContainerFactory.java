...
public class LdpContainerFactory {
	 ...
	 * @throws IOException
	 */
	public URI createDirectContainer(URI membershipResource, Property memberRelation, String name) throws FedoraException, IOException {
	 ...
	 * @throws IOException
	 */
	public URI createIndirectContainer(URI membershipResource, Property memberRelation, String name) throws FedoraException, IOException {
