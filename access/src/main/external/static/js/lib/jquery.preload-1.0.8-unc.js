...
;(function( $ ){
	...
	var $preload = $.preload = function( original, settings ){
		...
		function handler( e ){
			...
			if( settings.placeholder && orig.src ){ // special case when on placeholder mode
				if (settings.hidePlaceholderOnLoad){
					$(orig).hide();
				}
	...
	$preload.defaults = {
		...
		hidePlaceholderOnLoad: false, //Placeholder Mode: sets image to be hidden when its src loads to allow for fade ins without any flickering.
