...
<div id="about-repo" class="content-wrap">
    ...
    <p>Many collection materials in the DCR are made available openly or by ONYEN authentication without requiring
        registration with the Wilson Special Collections Library. However, the materials are still governed by the Wilson
    ...
    <p>Manuscript collections and archival records that include twentieth and twenty-first century materials may
        ...
        Carolina State Personnel Act (Privacy of State Employee Personnel Records, N.C.G.S. &sect; 126-22 et seq.). Researchers
    ...
    <p>Much of the material available in the Digital Collections Repository were acquired by the Library on various
        ...
        files to storage that is contemporary and optimized for long-term preservation. We employ best practices to analyze
        and migrate digital files from donated storage devices to the Digital Collections Repository
