...
public class FedoraContentService {
	...
	public void streamData(String simplepid, String datastream, OutputStream outStream, HttpServletResponse response, String fileExtension, boolean asAttachment){
		...
		try {
			...
			if (method.getStatusCode() == HttpStatus.SC_OK) {
				...
				try {
					...
					LOG.info("Problem retrieving " + dataUrl, e);
				} finally {
					method.releaseConnection();
				}
			} else {
