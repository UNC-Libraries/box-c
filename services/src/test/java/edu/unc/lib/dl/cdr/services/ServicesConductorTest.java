...
public class ServicesConductorTest extends Assert {
	...
	public void enhancementFailure(String serviceName){
		...
		servicesConductor.add(ManagementClientMock.PID_FILE_SYSTEM, serviceName);
		...
		servicesConductor.add(ManagementClientMock.PID_NOT_FOUND, serviceName);
		...
		//Test recoverable
		servicesConductor.add(ManagementClientMock.PID_FEDORA, TechnicalMetadataEnhancementService.class.getName());
		...
		//Test run time
		servicesConductor.add(ManagementClientMock.PID_RUN_TIME, TechnicalMetadataEnhancementService.class.getName());
