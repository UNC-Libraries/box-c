...
public class Mp44uAudioProcessorTest {
    ...
    private Mp44uAudioProcessor processor;
    ...
    public void init() {
        ...
        processor = new Mp44uAudioProcessor(mp44uThreads);
        ...
        when(message.getHeader(CdrFcrepoHeaders.CdrBinaryMimeType)).thenReturn("audio/aac");
    ...
    public void testMp44uAudioProcessor() throws Exception {
        ...
        try (MockedStatic<CLIMain> mockedStatic = mockStatic(CLIMain.class)) {
            ...
            mockedStatic.verify(() -> CLIMain.runCommand(new String[]{"mp44u", "audio",
    ...
    public void testNoFileInput() throws Exception {
        try (MockedStatic<CLIMain> mockedStatic = mockStatic(CLIMain.class)) {
            ...
            mockedStatic.verify(() -> CLIMain.runCommand(new String[]{"mp44u", "audio", "-i", null,
                    "-o", derivTmpPath, "-t", "8"}));
        }
    }
}
