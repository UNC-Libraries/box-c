...
public class SearchSettings extends AbstractSettings {
	...
	//Facet fields which should be treated as hierarchical facets.
	public HashSet<String> hierarchicalFacets;
	...
	public void setProperties(Properties properties){
		...
		hierarchicalFacets = new HashSet<String>();
		...
		setDefaultCollectionsPerPage(Integer.parseInt(properties.getProperty("search.results.defaultCollectionsPerPage", "0")));
		setDefaultListResultsPerPage(Integer.parseInt(properties.getProperty("search.results.defaultListResultsPerPage", "0")));
		...
		populateCollectionFromProperty("search.facet.hierarchical", hierarchicalFacets, properties, ",");
	...
	public HashSet<String> getHierarchicalFacets() {
		return hierarchicalFacets;
	}

	public void setHierarchicalFacets(HashSet<String> hierarchicalFacets) {
	...
	public void setDefaultCollectionResourceTypes(
			List<String> defaultCollectionResourceTypes) {
	...
	public String toString() {
		return "SearchSettings [queryMaxLength=" + queryMaxLength + ", defaultOperator=" + defaultOperator
				...
				+ ", collectionBrowseFacetNames=" + collectionBrowseFacetNames + ", hierarchicalFacets="
				+ hierarchicalFacets + ", facetDisplayOrder=" + facetDisplayOrder + ", facetSubfieldDelimiter="
