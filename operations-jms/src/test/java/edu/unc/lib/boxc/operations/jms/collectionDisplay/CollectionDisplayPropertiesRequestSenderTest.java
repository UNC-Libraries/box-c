...
public class CollectionDisplayPropertiesRequestSenderTest {
    @Mock
    private JmsTemplate jmsTemplate;
    private final CollectionDisplayPropertiesRequestSender collectionDisplayPropertiesRequestSender = new CollectionDisplayPropertiesRequestSender();
    ...
    public void setup() {
        ...
        collectionDisplayPropertiesRequestSender.setJmsTemplate(jmsTemplate);
    }
    ...
    public void sendToQueueTest() throws IOException {
        ...
        collectionDisplayPropertiesRequestSender.sendToQueue(request);
