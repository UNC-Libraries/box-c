...
public abstract class AbstractQueryService {
    ...
    private final static List<String> DEFAULT_RESULT_FIELDS = Arrays.asList(
            ...
            SearchFieldKey.COLLECTION_DISPLAY_SETTINGS.name(),
            ...
            SearchFieldKey.FILE_FORMAT_TYPE.name(),
            ...
            SearchFieldKey.OTHER_TITLE.name(),
            ...
            SearchFieldKey.STREAMING_TYPE.name(),
            SearchFieldKey.STREAMING_URL.name(),
