...
public class PremisEventLogger {
	...
	NORMALIZATION("normalization"), // A transformation of an object creating a version more conducive to preservation.
	REPLICATION("replication"), // The process of creating a copy of an object that is, bitwise, identical to the original.
	VALIDATION("validation"), // The process of comparing and object with a standard and noting compliance or exceptions.
	...
	if (detailNote != null || detailExtension != null) {
		...
		eventOutcomeDetail.addContent(new Element("eventOutcomeDetailExtension", NS)
