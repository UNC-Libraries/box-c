 ...
 * This identifier scheme is compatible with both the Fedora PID and a URN.  PIDs
 * are of the form "uuid:21a579fb-7bca-4025-88c0-345ee293725b".  Note that datastream
 * PIDs and datastream version PIDs will be uniquely persistent, but will not be compatible with URN.
 */
