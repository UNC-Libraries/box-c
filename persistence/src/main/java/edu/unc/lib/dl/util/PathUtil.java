...
public class PathUtil {
    ...
    /**
     * Adds an underscore and a number to a slug string. If the input string
     * already ends with an underscore and a string of digits, then it will
     * increment the number. (leading zeros on the digits are removed)
     *
     * @param input
    ...
    /**
     * Replaces non-alphanumeric character groups with an underscore and removes
     * any leading or trailing underscores.
     *
     * @param input
