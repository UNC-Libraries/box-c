...
private static final Logger LOG = LoggerFactory.getLogger(OperationsMessageSender.class);
    ...
    public void sendAddOperation(String userid, String timestamp, Collection<PID> destinations, Collection<PID> added, Collection<PID> reordered) {
    ...
    public void sendRemoveOperation(String userid, String timestamp, PID destination, Collection<PID> removed, Collection<PID> reordered) {
	Document msg = new Document();
    ...
    public void sendMoveOperation(String userid, String timestamp, Collection<PID> sources, PID destination, Collection<PID> moved, Collection<PID> reordered) {
	Document msg = new Document();
