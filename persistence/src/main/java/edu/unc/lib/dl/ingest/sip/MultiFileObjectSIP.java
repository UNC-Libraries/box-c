...
/**
 * This submission package is composed of a single file file, plus MODS
...
public class MultiFileObjectSIP implements SubmissionInformationPackage {
    ...
    /**
     * Set which datastream holds the default web representation, if any. The
     * specified datastream object must also be in the list of datastreams for
     * the SIP.
     *
    ...
    /**
     * Tells the repository whether or not to index this object. (Default is
     * yes)
     *
     * @param allowIndexing
     */
