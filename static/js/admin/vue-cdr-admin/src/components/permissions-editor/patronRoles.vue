<template>
    <div id="patron-roles">
        <p class="duracloud-note">Access control changes here will not change settings in Duracloud, any corresponding
            changes must be made in Duracloud itself</p>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getRoles() {
                if (this.isBulkMode) {
                    wretch(`/services/api/acl/patron/allowedPrincipals`)
                        .get()
                        .json((data) => {
                            this.allowed_principals = data;
                ...
                wretch(`/services/api/acl/patron/${this.uuid}`)
                    .get()
                    .json((data) => {
                        this.setEmbargoInfo({
            ...
            _saveSingle() {
                ...
                wretch(`/services/api/edit/acl/patron/${this.uuid}`)
            ...
            _saveBulk() {
                ...
                wretch(`/services/api/edit/acl/patron`)
                    .headers({ 'Content-Type': 'application/json; charset=utf-8' })
