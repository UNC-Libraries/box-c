...
if (document.getElementById('app') !== null && window.dcr_browse_records === undefined) {
    ...
    window.turnstileEnabled = String(import.meta.env.VITE_CF_TURNSTILE_ENABLED || 'true').toLowerCase();
    window.challengefullRecord = String(import.meta.env.VITE_CF_TURNSTILE_CHALLENGE_FULL_RECORD || 'false').toLowerCase();
