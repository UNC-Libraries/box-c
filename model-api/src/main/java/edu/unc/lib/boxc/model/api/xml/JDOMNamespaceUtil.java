...
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.ATOM_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.ATOM_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.CDR_MESSAGE_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.CDR_MESSAGE_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.CDR_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.CDR_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DCR_PACKAGING_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DCR_PACKAGING_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DCTERMS_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DCTERMS_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DC_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.DC_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FEDORA_MODEL_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FEDORA_MODEL_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FEDORA_VIEW_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FEDORA_VIEW_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FITS_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FITS_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.FOXML_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.LOCAL_RELS_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.LOCAL_RELS_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.METS_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.METS_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.MODS_V3_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.MODS_V3_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.MULGARA_TQL_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.OAI_DC_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.OAI_DC_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.PREMIS_V2_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.PREMIS_V2_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.PREMIS_V3_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.PREMIS_V3_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.RDF_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.RDF_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.RELSEXT_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.RELSEXT_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.SCHEMATRON_VALIDATION_REPORT_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.SCHEMATRON_VALIDATION_REPORT_URI;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.XLINK_PREFIX;
import static edu.unc.lib.boxc.model.api.xml.NamespaceConstants.XLINK_URI;
