...
@Endpoint
public class GetItemInfoEndpoint extends WebServiceGatewaySupport {
    private final Logger logger = Logger.getLogger(getClass());
    private ItemInfoService itemInfoService;

    @PayloadRoot(localPart = Constants.ITEM_INFO_REQUEST, namespace = Constants.NAMESPACE)
    public ItemInfoResponse getData(ItemInfoRequest itemInfoRequest) {

    logger.debug("here");	
    	
	return itemInfoService.getItemInfo(itemInfoRequest);
    }
