...
@Endpoint
public class ContainerQueryEndpoint {
    private final Logger logger = Logger.getLogger(getClass());
    private ItemInfoService itemInfoService;

    @PayloadRoot(localPart = Constants.CONTAINER_QUERY, namespace = Constants.NAMESPACE)
    public ContainerQuery isContainer(ContainerQuery containerQuery) {
    	ContainerQuery temp = new ContainerQuery();
    
    	temp.setContainer(itemInfoService.isContainer(containerQuery.getIrUrlInfo()));
