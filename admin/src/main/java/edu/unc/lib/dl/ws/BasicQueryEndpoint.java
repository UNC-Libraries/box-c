...
@Endpoint
public class BasicQueryEndpoint {
    private final Logger logger = Logger.getLogger(BasicQueryEndpoint.class);

    private SearchService searchService;

    @PayloadRoot(localPart = Constants.BASIC_QUERY_REQUEST, namespace = Constants.NAMESPACE)
    public BasicQueryResponseList getSearchResult(
	    BasicQueryRequest basicQueryRequest) {

	return searchService.basicQuery(basicQueryRequest);
    }
