...
@Endpoint
public class MetsSubmitEndpoint extends WebServiceGatewaySupport {
	private final Logger logger = Logger.getLogger(getClass());

	private SubmitService submitService;

	@PayloadRoot(localPart = Constants.METS_SUBMIT_INGEST_OBJECT, namespace = Constants.NAMESPACE)
	public MetsSubmitIngestObject metsSubmit(MetsSubmitIngestObject request) {

		return submitService.metsSubmit(request);
