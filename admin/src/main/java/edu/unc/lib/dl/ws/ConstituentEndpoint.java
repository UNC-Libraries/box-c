...
@Endpoint
public class ConstituentEndpoint {
	private final Logger logger = Logger.getLogger(getClass());
	private ConstituentService constituentService;

	@PayloadRoot(localPart = Constants.PATH_INFO_REQUEST, namespace = Constants.NAMESPACE)
	public PathInfoResponse getBreadcrumbs(PathInfoRequest pathInfoRequest) {

		return constituentService.getBreadcrumbs(pathInfoRequest.getPid());
	}
