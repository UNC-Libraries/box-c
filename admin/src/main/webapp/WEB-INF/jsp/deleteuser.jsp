...
<title><fmt:message key="um.user.delete.heading" /></title>
...
<h1><fmt:message key="um.user.delete.heading" /></h1>
</div>
<form action="deleteuser" commandName="userGroupDAO">
...
<form:select path="userGroupDAO.pid">
            <option value=""><fmt:message key="um.user.delete.select" /></option>            
