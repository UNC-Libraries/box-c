...
<title><fmt:message key="um.group.create.heading" /></title>
...
<h1><fmt:message key="um.group.create.heading" /></h1>
</div>
...
<table width="40%" bgcolor="f8f8ff" border="0" cellspacing="0"
	...
	<tr>
		<td alignment="right" width="20%"><fmt:message key="um.group.name"/></td>
			<td width="20%" alignment="right"><input type="text" name="groupName"></td>
	</tr>
</table>
<br>
<br>
