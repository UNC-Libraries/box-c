...
<title><fmt:message key="um.group.user.remove.heading" /></title>
...
<h1><fmt:message key="um.group.user.remove.heading" /></h1>
</div>
...
<br>
<br>
<input type="submit" alignment="center" value=<fmt:message key="um.group.user.remove.heading"/> name="_target0"></form:form>
